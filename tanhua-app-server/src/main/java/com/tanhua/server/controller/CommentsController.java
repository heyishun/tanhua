...
public class CommentsController {
     ...
     */
    @GetMapping("/{id}/like")
    public ResponseEntity like(@PathVariable("id") String commendId){
        Integer likeCount=commentsService.likeMComment(commendId);
    ...
    public ResponseEntity dislike(@PathVariable("id") String commendId){
        Integer likeCount=commentsService.dislikeMComment(commendId);
        return ResponseEntity.ok(likeCount);
    }
}
